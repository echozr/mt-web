...
<div class="m-life">
    <el-row>
        ...
        <el-col :span="4"><div class="m-life-pic" /></el-col>
        <el-col :span="6">
    ...
    <el-row>
        <el-col :span="7"><div class="m-life-hotel" /></el-col>
        <el-col :span="7"><div class="m-life-music" /></el-col>
        <el-col :span="4"><div class="m-life-coop" /></el-col>
        <el-col :span="6">
